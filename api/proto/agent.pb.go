...
func (x *RuntimeConfig) GetResourceTier() string {
	if x != nil {
...
const file_api_proto_agent_proto_rawDesc = "" +
	...
	"\rRuntimeConfig\x12#\n" +
	"\rresource_tier\x18\x01 \x01(\tR\fresourceTier\x12<\n" +
...
var file_api_proto_agent_proto_goTypes = []any{
	...
	(*RuntimeConfig)(nil),     // 1: agent.RuntimeConfig
	(*PortMapping)(nil),       // 2: agent.PortMapping
	(*HealthCheckConfig)(nil), // 3: agent.HealthCheckConfig
	(*DeployResponse)(nil),    // 4: agent.DeployResponse
	(*StopRequest)(nil),       // 5: agent.StopRequest
	(*StopResponse)(nil),      // 6: agent.StopResponse
	(*GetStatusRequest)(nil),  // 7: agent.GetStatusRequest
	(*GetStatusResponse)(nil), // 8: agent.GetStatusResponse
	(*StreamLogsRequest)(nil), // 9: agent.StreamLogsRequest
	(*LogEntry)(nil),          // 10: agent.LogEntry
	nil,                       // 11: agent.DeployRequest.SecretsEntry
	nil,                       // 12: agent.RuntimeConfig.EnvVarsEntry
}
var file_api_proto_agent_proto_depIdxs = []int32{
	1,  // 0: agent.DeployRequest.config:type_name -> agent.RuntimeConfig
	11, // 1: agent.DeployRequest.secrets:type_name -> agent.DeployRequest.SecretsEntry
	12, // 2: agent.RuntimeConfig.env_vars:type_name -> agent.RuntimeConfig.EnvVarsEntry
	2,  // 3: agent.RuntimeConfig.ports:type_name -> agent.PortMapping
	3,  // 4: agent.RuntimeConfig.health_check:type_name -> agent.HealthCheckConfig
	0,  // 5: agent.AgentService.Deploy:input_type -> agent.DeployRequest
	5,  // 6: agent.AgentService.Stop:input_type -> agent.StopRequest
	7,  // 7: agent.AgentService.GetStatus:input_type -> agent.GetStatusRequest
	9,  // 8: agent.AgentService.StreamLogs:input_type -> agent.StreamLogsRequest
	4,  // 9: agent.AgentService.Deploy:output_type -> agent.DeployResponse
	6,  // 10: agent.AgentService.Stop:output_type -> agent.StopResponse
	8,  // 11: agent.AgentService.GetStatus:output_type -> agent.GetStatusResponse
	10, // 12: agent.AgentService.StreamLogs:output_type -> agent.LogEntry
